    ...
    <DashboardLayout>
      <div className="max-w-6xl mx-auto space-y-4 sm:space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-foreground mb-2">Secure Document Viewer</h1>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            {viewingMode ? (
              <Button onClick={exitViewingMode} variant="outline" className="w-full sm:w-auto text-sm sm:text-base">
                Exit Viewing Mode
              </Button>
            ) : (
              <Button onClick={enterViewingMode} className="bg-red-600 hover:bg-red-700 w-full sm:w-auto text-sm sm:text-base">
                <Eye className="w-4 h-4 mr-2" />
                Secure View
              </Button>
            )}
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          <Card className="p-3 sm:p-4">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="min-w-0">
                <p className="text-xs sm:text-sm font-medium truncate">Security Status</p>
          ...
          <Card className="p-3 sm:p-4">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="min-w-0">
                <p className="text-xs sm:text-sm font-medium truncate">Viewing Mode</p>
          ...
          <Card className="p-3 sm:p-4">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="min-w-0">
                <p className="text-xs sm:text-sm font-medium truncate">Screenshots Blocked</p>
          ...
          <Card className="p-3 sm:p-4">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="min-w-0">
                <p className="text-xs sm:text-sm font-medium truncate">Session Time</p>
                <p className="text-xs text-muted-foreground">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground">
                    Owner: {documentData?.owner} • CID: {documentData?.cid.substring(0, 8)}...
                  </p>
                </div>
              </div>

              <div className="flex flex-wrap items-center gap-2">
                <Badge variant={viewingMode ? "default" : "secondary"} className="text-xs">
        ...
        <Card className="p-4 sm:p-6 bg-yellow-50 border-yellow-200">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              <h4 className="font-semibold text-yellow-800 mb-2 text-sm sm:text-base">Security Measures Active</h4>
              <ul className="text-xs sm:text-sm text-yellow-700 space-y-1">
                ...
                {securityViolations.length > 0 && (
                  <div className="mt-4 p-2 sm:p-3 bg-red-50 border border-red-200 rounded">
                    <p className="text-xs sm:text-sm font-medium text-red-800 mb-2">Recent Violations:</p>
                    <ul className="text-xs text-red-700 space-y-1 max-h-16 sm:max-h-20 overflow-y-auto">
                      {securityViolations.slice(-3).map((violation, index) => (
                        <li key={index} className="break-words">• {violation.split(': ')[1]}</li>
                      ))}
                    </ul>
                  </div>
                )}
