...
import { Shield, Lock, FileCheck, Server, Menu, X, Eye, Clock, CheckCircle } from "lucide-react";
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="animate-fade-in">
            ...
            <p className="text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
              <strong>Sield</strong> brings enterprise-grade encryption and blockchain transparency together. Store, share, and audit sensitive legal documents with complete confidence using BlockDAG technology. Experience secure one-time document viewing with time-limited access and comprehensive audit trails.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-foreground mb-4">
              How Secure Document Viewing Works
            </h2>
            <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
              Experience the future of secure document sharing with Sield's one-time viewing system. Every step is protected by blockchain technology and enterprise-grade security.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">1. Grant Access</h3>
              <p className="text-muted-foreground">
                Document owners create secure access grants with specific wallet addresses and time limits. Each grant generates a unique, one-time access key.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-secondary/10 rounded-xl flex items-center justify-center mx-auto mb-6">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">2. Secure Viewing</h3>
              <p className="text-muted-foreground">
                Authorized viewers enter their wallet address and access key to view documents. Content is displayed with security measures including screenshot blocking and time limits.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-secondary/10 rounded-xl flex items-center justify-center mx-auto mb-6">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">3. Complete Audit</h3>
              <p className="text-muted-foreground">
                Every action is permanently recorded on the BlockDAG blockchain. Access can be revoked instantly, and comprehensive audit logs ensure complete transparency.
              </p>
            </div>
          </div>

          <div className="bg-gradient-card rounded-2xl p-8 border border-border max-w-4xl mx-auto">
            <h3 className="text-2xl font-bold text-foreground text-center mb-6">Security Features</h3>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex items-start gap-4">
                <Clock className="w-6 h-6 text-secondary mt-1 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-foreground mb-2">Time-Limited Access</h4>
                  <p className="text-muted-foreground text-sm">Documents automatically expire after the set time period, ensuring temporary access only.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <Shield className="w-6 h-6 text-secondary mt-1 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-foreground mb-2">Screenshot Protection</h4>
                  <p className="text-muted-foreground text-sm">Advanced security measures prevent unauthorized capture of document content.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <Lock className="w-6 h-6 text-secondary mt-1 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-foreground mb-2">One-Time Use</h4>
                  <p className="text-muted-foreground text-sm">Each access key can only be used once, preventing unauthorized sharing.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <FileCheck className="w-6 h-6 text-secondary mt-1 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-foreground mb-2">Blockchain Audit</h4>
                  <p className="text-muted-foreground text-sm">Every view and action is immutably recorded for complete accountability.</p>
                </div>
              </div>
            </div>
          </div>
